...
export default function Home() {
  return (
    <main className="flex min-h-screen tracking-wider flex-col items-center justify-between p-24">
      <section className="bg-white font-pBold rounded-lg dark:bg-gray-900">
