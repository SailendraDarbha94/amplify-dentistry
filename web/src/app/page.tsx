      ...
      <section className="bg-white dark:bg-gray-900 rounded-lg mb-10">
        <div className="gap-16 max-w-screen-xl items-center py-8 px-4 mx-auto lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="mb-4 font-pBold text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              Powered by AI
            </h2>
            <p className="mb-4 font-pMedium">
              Whether you have doubts that need to be resolved or you just want
              to plan your studies, our helpful AI companion will assist you
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <img
              ...
              src="/amplify-white-bg.jpg"
              alt="office content 1"
            />
            <img
              className="mt-4 w-full lg:mt-10 rounded-lg"
              src="/ampdent-logo-w-bg.jpg"
              alt="office content 2"
            />
          </div>
        </div>
      </section>
      <section className="bg-white dark:bg-gray-900 rounded-lg mb-10" id="feature-section">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 font-pBold text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
              Designed to empower Students
            </h2>
            <p className="text-gray-500 font-pMedium sm:text-xl dark:text-gray-400">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-pExtraBold dark:text-white">
                Theory
              </h3>
              <p className="text-gray-500 font-pLight dark:text-gray-400">
            ...
            <div>
              ...
              <p className="text-gray-500 font-pLight dark:text-gray-400">
                We use AI to generate MCQs which means that you can practice new
                quizzes everyday and not get bored.
              </p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400 font-pLight">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 font-pLight">
                ...
                knowledge and it is something you have to experience to realise
                it&apos;s power.
              </p>
            </div>
          </div>
